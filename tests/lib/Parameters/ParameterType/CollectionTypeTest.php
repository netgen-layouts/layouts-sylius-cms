...
final class CollectionTypeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->type = new CollectionType($this->repositoryStub);
    }

    public function testGetIdentifier(): void
    {
        self::assertSame('sylius_cms_collection', $this->type::getIdentifier());
    }
    ...
    public static function emptyDataProvider(): iterable
    {
        return [
            [null, true],
            [new CollectionStub(42, 'blog'), false],
        ];
    }
    ...
    public function testGetValueObject(): void
    {
        ...
        /** @var \Netgen\Layouts\Sylius\Cms\Parameters\ParameterType\CollectionType $type */
        $type = $this->type;

        self::assertSame($collection, $type->getValueObject(42));
    }
